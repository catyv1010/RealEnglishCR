...
Real English CR es una academia (ficticia) de ingles con cinco sedes en Costa Rica: San Jose, Heredia, Cartago, Alajuela y Liberia. Aca esta la parte web, o sea las paginas que ve el usuario. Mas adelante el modelo se conecta a la base de datos en Oracle usando PHP con la extension OCI8.
...
- `model/` - el modelo. Por ahora vacio; aca va la conexion a Oracle en el Avance 2.
...
4. En el navegador entrar a: `http://localhost/RealEnglishCR/`
...
- Bootstrap y jQuery
- PHP con patron MVC
- Oracle + OCI8 (la conexion se hace en el Avance 2)
...
- [ ] Conexion del modelo a Oracle con PHP / OCI8
- [ ] Validaciones e ingreso real de datos
